...
export default function IndexThree() {
  return (
    <>
      ...
      <section
        className='relative pt-24 xl:pb-[420px] md:pb-80 pb-36 items-center overflow-hidden bg-red-500 bg-center bg-no-repeat bg-cover'
        id='home'
        style={{ backgroundImage: `url(${bg})` }}
      >
        <div className='container relative'>
          <div className='grid grid-cols-1 mt-10 text-center'>
            <h3 className='font-bold lg:leading-normal leading-normal text-4xl lg:text-6xl mb-5 text-white'>
              Get started with <br /> Appever Template.
            </h3>
